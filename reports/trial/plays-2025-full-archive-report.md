# Plays 2025 full archive (Step 9E)

Generated: 2026-09-09T22:55:37.731Z

**Archive verdict:** HIGH_VALUE_ARCHIVE_CONFIRMED

**Step verdict:** GREEN — full Plays archive confirms high-value event and rotation data

**Rotation reliability:** "GOOD"

Do NOT start 2022. Do NOT build possessions or WOWY. Do NOT create serving tables.

Machine-readable: `reports/trial/plays-2025-full-archive-report.json`
...
{
  "characterizationPrefix": "raw/source=balldontlie/league=nba/season=2025/entity=plays/_characterization_10game",
  "reusableValid": 10,
  "alreadyCanonical": 188,
  "needCopy": 0,
  "needFetch": 1134,
...
## Time Gate
{
  "trialElapsedHours": 30.304,
  "trialRemainingHours": 17.696,
  "protectedReserveHours": 6,
  "usableAfterReserveHours": 11.696,
  "reusableResponses": 10,
  "requiredProviderRequests": 1134,
  "projectedCrawlMs": 14742000,
  "projectedCrawlHours": 4.095,
  "projectedRemainingAfterCrawlHours": 13.601,
  "maxAllowedHours": 6,
  "proceed": true
}
...
## Acquisition Result
{
  ...
  "stoppedReason": null,
  "totalEvents": 642354,
  "averageEventsPerGame": 485.9,
  "minEventsPerGame": 399,
  "maxEventsPerGame": 644,
  "httpAttempts": 1134,
  "httpSuccess": 1134,
  "status429": 0,
  "retries": 0,
  "retryAfterUsed": 0,
  "wallClockMs": 15700653
}

## Rate-Limit Result
{
  "configuredSpacingMs": 13000,
  "concurrency": 1,
  "averageMs": 13856.8,
  "minimumMs": 13650,
  "maximumMs": 16607,
  "minObservedAtLeast12000": true
}
...
## Event-Type Inventory
{
  "distinctTypes": 137,
  "topTypes": {
    "Defensive Rebound": 91956,
    "Substitution": 82649,
    "Jump Shot": 68666,
    "Offensive Rebound": 47335,
    "Pullup Jump Shot": 27738,
    "Shooting Foul": 27437,
    "Free Throw - 1 of 2": 25501,
    "Free Throw - 2 of 2": 25479,
    "Driving Layup Shot": 21160,
    "Personal Foul": 16182,
    "Full Timeout": 14282,
    "Driving Floating Jump Shot": 13684,
    "Bad Pass\nTurnover": 13608,
    "Step Back Jump Shot": 12234,
    "Lost Ball Turnover": 8877,
    "Running Layup Shot": 8367,
    "Running Jump Shot": 6879,
    "Free Throw - 1 of 1": 6578,
    "Driving Finger Roll Layup": 6285,
    "Cutting Layup Shot": 5539,
    "End Period": 5356,
    "Tip Shot": 5044,
    "Fade Away Jump Shot": 4472,
    "Out of Bounds - Bad Pass Turnover": 4463,
    "Layup Shot Putback": 4112
  },
  "substitution": 82649,
  "scoringPlays": 159050,
  "shootingPlays": 298340,
  "groups": {
    "jump_ball": [
      "Jumpball",
      "Jump Ball",
      "Jumpball Violation Turnover"
    ],
    "other": [
      "Jump Shot",
      "Cutting Layup Shot",
    ...
    "free_throw": [
      ...
      "Free Throw - Flagrant 2 of 3",
      "Free Throw - Flagrant 1 of 3",
...
## Starter Eligibility
{
  ...
  "notEligible": [
    {
      "gameId": "18447931",
      "reason": "starter_archive_anomaly",
      "counts": {
        "10": 4,
        "27": 5
      }
...
{
  "eligible": 1320,
  "reconstructedSuccessfully": 1284,
  "failed": 36,
  "successPct": 97.27,
  "reliability": "GOOD"
}
...
[
  {
    ...
    "order": 78,
    "type": "Substitution",
    "text": "Brandin Podziemski enters the game for Jimmy Butler III",
    "participants": [
      "56677858",
      "79"
    ],
  ...
  },
  {
    ...
    "order": 11,
    "type": "Substitution",
    "text": "Jaylen Wells enters the game for Ja Morant",
    "participants": [
      "1028039105",
      "666786"
    ],
  ...
  },
  {
    ...
    "order": 120,
    "type": "Substitution",
    "text": "Cody Martin enters the game for Jeremiah Robinson-Earl",
    "participants": [
      "17896021"
    ],
    "teamId": "12",
    ...
    "classification": "MISSING_PARTICIPANT",
    "periodBoundary": false
  },
  {
    "gameId": "18446957",
    ...
    "order": 48,
    "type": "Substitution",
    "text": "Monte Morris enters the game for Andrew Nembhard",
    "participants": [
      "38017507"
    ],
    "teamId": "12",
  ...
  },
  {
    ...
    "order": 36,
    "type": "Substitution",
    "text": "Cody Martin enters the game for Jarace Walker",
    "participants": [
      "56677832"
    ],
    "teamId": "12",
  ...
  },
  {
    ...
    "order": 110,
    "type": "Substitution",
    "text": "Monte Morris enters the game for Jarace Walker",
    "participants": [
      "56677832"
    ],
    "teamId": "12",
  ...
  },
  {
    ...
    "order": 351,
    "type": "Substitution",
    "text": "Jamal Murray enters the game for Tim Hardaway Jr.",
    "participants": [
      "335",
      "191"
    ],
  ...
  },
  {
    ...
    "order": 533,
    "type": "Substitution",
    "text": "Monte Morris enters the game for Pascal Siakam",
    "participants": [
      "416"
    ],
    "teamId": "12",
  ...
  },
  {
    ...
    "order": 346,
    "type": "Substitution",
    "text": "Ryan Rollins enters the game for Gary Harris",
    "participants": [
      "38017712",
      "196"
    ],
  ...
  },
  {
    ...
    "order": 501,
    "type": "Substitution",
    "text": "Zach Edey enters the game for ",
    "participants": [
      "1028025754"
    ],
    "teamId": "15",
  ...
  },
  {
    ...
    "order": 389,
    "type": "Substitution",
    "text": "Collin Murray-Boyles enters the game for ",
    "participants": [
      "1057268940"
    ],
    "teamId": "28",
  ...
  },
  {
    ...
    "order": 46,
    "type": "Substitution",
    "text": "OG Anunoby enters the game for Mikal Bridges",
    "participants": [
      "18",
      "61"
    ],
  ...
  },
  {
    ...
    "order": 384,
    "type": "Substitution",
    "text": "enters the game for Jordan Miller",
    "participants": [
      "56677856"
    ],
    "teamId": "13",
  ...
  },
  {
    ...
    "order": 517,
    "type": "Substitution",
    "text": "Kevin Durant enters the game for Alperen Sengun",
    "participants": [
      "140",
      "17896062"
    ],
  ...
  },
  {
    ...
    "order": 438,
    "type": "Substitution",
    "text": "Zach LaVine enters the game for ",
    "participants": [
      "268"
    ],
    "teamId": "26",
  ...
  },
  {
    ...
    "order": 267,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Brandin Podziemski",
    "participants": [
      "56677858"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 46,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Al Horford",
    "participants": [
      "219"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 57,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Gui Santos",
    "participants": [
      "57875092"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 48,
    "type": "Substitution",
    "text": "Sandro Mamukelashvili enters the game for ",
    "participants": [
      "17896059"
    ],
    "teamId": "28",
  ...
  },
  {
    ...
    "order": 80,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Gary Payton II",
    "participants": [
      "2189"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 194,
    "type": "Substitution",
    "text": "Bam Adebayo enters the game for Tyler Herro",
    "participants": [
      "4",
      "666633"
    ],
  ...
  },
  {
    ...
    "order": 234,
    "type": "Substitution",
    "text": "Marvin Bagley III enters the game for Klay Thompson",
    "participants": [
      "24",
      "443"
    ],
  ...
  },
  {
    ...
    "order": 165,
    "type": "Substitution",
    "text": "Jalen Duren enters the game for ",
    "participants": [
      "38017694"
    ],
    "teamId": "9",
  ...
  },
  {
    ...
    "order": 470,
    "type": "Substitution",
    "text": "Ryan Dunn enters the game for ",
    "participants": [
      "1028025723"
    ],
    "teamId": "24",
  ...
  },
  {
    ...
    "order": 55,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Will Richard",
    "participants": [
      "1057395872"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 64,
    "type": "Substitution",
    "text": "Nate Williams enters the game for LJ Cryer",
    "participants": [
      "1057968644"
    ],
    "teamId": "10",
  ...
  },
  {
    ...
    "order": 415,
    "type": "Substitution",
    "text": "enters the game for Tari Eason",
    "participants": [
      "38017695"
    ],
    "teamId": "11",
  ...
  },
  {
    ...
    "order": 124,
    "type": "Substitution",
    "text": "Nate Williams enters the game for Malevy Leons",
    "participants": [
      "1028265620"
    ],
    "teamId": "10",
...
{
  "substitutionFailuresAtPeriodChange": [
    {
      "gameId": "18447741",
      "date": "2026-03-08",
      "matchup": "DET @ MIA",
...
## Substitution Statistics
{
  ...
  "min": 1,
  "max": 101,
  "regularSeasonGames": 1235,
  "postseasonGames": 85,
  "regularSeasonMedian": 62,
  "postseasonMedian": 66,
  "gamesWithZeroSubstitutions": [],
  "meanSubsPerTeamGame": 30.69
}
...
{
  "target": 1322,
  "canonicalGameObjects": 1322,
  "missingCanonical": [],
  "invalidCanonical": [],
  "totalEvents": 642354,
  "certifiedEventsSum": 642354,
  "eventsMatchSum": true,
  "failedGames": [],
  "zeroResult": 0,
  "characterizationPrefixPreserved": "raw/source=balldontlie/league=nba/season=2025/entity=plays/_characterization_10game",
  "characterizationObjects": 10,
  "bytes": 593594468,
  "mb": 566.1,
  "averageKbPerGame": 438.5,
...
{
  "historicalGameTimeline": true,
  "scoringRuns": true,
  "leadChanges": true,
  "quarterByQuarterEventFlow": true,
  "clutchTimeline": true,
  "starterPlusSubstitutionReconstruction": "GOOD",
  "fiveManUnitTimeline": true,
...
{
  "elapsedHours": 34.744,
  "remainingHours": 13.256,
  "protectedReserveHours": 6,
  "usableRemainingHours": 7.256
}
