...
/**
 * Manual Player Resolution for November
 * 
 * Resolves players we know exist but can't be auto-matched
 */
...
const manualMappings: Array<{ scrapedName: string; teamCode: string; playerId: string; dbName: string }> = [
  ...
  { scrapedName: 'Monte Morris', teamCode: 'IND', playerId: '1628420', dbName: 'Monté Morris' },
  { scrapedName: 'Kasparas Jakucionis', teamCode: 'MIA', playerId: '1642857', dbName: 'Kasparas Jakučionis' },
];

async function main() {
  console.log('🔧 Manually resolving known players...\n');
