  ...
  return (
    <AuthSplitLayout
      topRight={
        <>
          ...
          <Link href={signupHref} className="type-interactive text-[#075B5C] hover:underline">
            Create an account
          </Link>
        </>
      }
    >
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="type-metadata">or</span>
        <div className="h-px flex-1 bg-[#DCE9EA]" />
      </div>
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[#4a6366] hover:text-[#063f46]"
        ...
        <button
          type="submit"
          disabled={loading}
          className="type-interactive group w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#55ddb1] py-3.5 text-[#063f46] hover:bg-[#3dcc9f] disabled:opacity-50 transition-colors"
        >
